...
const Buttons = ({ handleRefresh, selectedRows }) => {
    ...
    const handleDelete = async () => {
        ...
        await axios({
            method: "post",
            url: `http://localhost:8080/milestone3/delete/${slNos}`,
            headers: {
    ...
    const handleEdit = () => {
        ...
        axios
            .put(`http://localhost:8080/milestone3/edit/${slNos}?orderCurrency=${editedOrderCurrency}&companyCode=${editedCompanyCode}&distributionChannel=${editedDistributionChannel}`,
            )
            .then((response) => {
