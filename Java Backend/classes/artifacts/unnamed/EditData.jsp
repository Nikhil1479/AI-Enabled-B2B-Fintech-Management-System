...
<body>
    ...
    <form action="EditServlet" method="POST">
        ...
        <input type="number" id="releasedCreditValue" name="releasedCreditValue" required><br><br>
        
        <label for="purchaseOrderType">Purchase Order Type:</label>
        <input type="text" id="purchaseOrderType" name="purchaseOrderType" required><br><br>
        ...
        <input type="text" id="orderCreationTime" name="orderCreationTime" required><br><br>
        
        <label for="creditControlArea">Credit Control Area:</label>
        <input type="text" id="creditControlArea" name="creditControlArea" required><br><br>
        
        <label for="soldToParty">Sold To Party:</label>
        <input type="number" id="soldToParty" name="soldToParty" required><br><br>
        
        <label for="orderAmount">Order Amount:</label>
        <input type="number" id="orderAmount" name="orderAmount" required><br><br>
        
        <label for="requestedDeliveryDate">Requested Delivery Date:</label>
        <input type="text" id="requestedDeliveryDate" name="requestedDeliveryDate" required><br><br>
        ...
        <input type="text" id="creditStatus" name="creditStatus" required><br><br>
        ...
        <label for="uniqueCustID">Unique Customer ID:</label>
        <input type="number" id="uniqueCustID" name="uniqueCustID" required><br><br>
